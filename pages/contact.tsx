            ...
            <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
              <div className="flex flex-col gap-2">
                ...
                <input
                 ...
                 focus:border-[1px] bg-darkbg rounded-md transition delay-none border-3a border-[.5px] duration-300 placeholder:text-zinc-600"
                  id="name"
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                 ...
                 bg-darkbg rounded-md transition delay-none border-3a border-[.5px] duration-300 placeholder:text-zinc-600"
                  id="email"
                  required
