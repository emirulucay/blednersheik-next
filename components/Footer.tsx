...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-24 before:absolute before:-top-[1px] before:bg-a2 before:w-full before:h-[0.5px] z-10 before:z-10 bg-09 py-12 content-end flex items-center justify-center">
